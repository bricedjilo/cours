...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-sm-12">
            ...
            <form id="edit-chapter-homework" method="POST"
                ...
                <div class="form-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="chapter_hw_files[]"
                ...
                <a href="{{ route('edit-chapter', ['chapter' => $homework->chapter]) }}" class="btn btn-secondary">
                    Annuler
                </a>
            </form>
