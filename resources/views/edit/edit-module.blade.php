...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-sm-12">
            ...
            <form id="edit-module" method="POST" action="{{ route('update-module', ['module' => $module]) }}"
                ...
                <div class="form-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="module_files[]"
                ...
                <a href="{{ route('edit-subject', ['subject' => $module->subject]) }}" class="btn btn-secondary">
                    Annuler
                </a>
            </form>
            ...
            <form id="delete-module-file" action="{{ route('delete-module-up-file', ['module' => $module]) }}"
                method="POST">
                @csrf
                @method('DELETE')
                <div class="form-group">
            ...
            <form id="delete-module" action="{{ route('delete-module', ['module' => $module]) }}" method="POST">
                @csrf
                @method('DELETE')
