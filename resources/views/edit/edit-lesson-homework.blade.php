...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-sm-12">
            ...
            <h5>Moodule {{ $homework->lesson->chapter->module->number }}:
                {{ $homework->lesson->chapter->module->title }}</h5>
            ...
            <form id="edit-lesson-homework" method="POST"
                ...
                <div class="form-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="lesson_hw_files[]"
                ...
                <a href="{{ route('edit-lesson', ['lesson' => $homework->lesson]) }}" class="btn btn-secondary">
                    Annuler
                </a>
            </form>
            ...
            <form id="delete-lesson-hw-file" action="{{ route('delete-homework-up-file', ['homework' => $homework]) }}"
                method="POST">
                @csrf
                @method('DELETE')
                <div class="form-group">
