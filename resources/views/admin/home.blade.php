...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-10 col-sm-12 col-xs-12">
            ...
            <h4><a href="">Modifier un eleve</a></h4>
            <h4><a href="">Supprimer un eleve</a></h4>
        </div>
    </div>
    <div class="row justify-content-center mt-4">
        <div class="col-lg-6 col-md-10 col-sm-12 col-xs-12">
            ...
            <h4><a href="">Modifier un prof</a></h4>
            <h4><a href="">Supprimer un prof</a></h4>
        </div>
    </div>
    <div class="row justify-content-center mt-4">
        <div class="col-lg-6 col-md-10 col-sm-12 col-xs-12">
            ...
            <h4><a href="">Modifier un membre du staff</a></h4>
            <h4><a href="">Supprimer un membre du staff</a></h4>
        </div>
    </div>
    <hr>
    <div class="row justify-content-center mt-4">
