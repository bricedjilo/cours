        ...
        <div class="col-lg-6 col-sm-12">
            ...
            <form method="POST" action="/modules" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" name="{{ $subject->id }}" class="form-control" disabled id="subject-name"
                        value="{{ $subject->name }} - {{ $subject->classe->name }}">
                </div>
                <div class="form-group">
                    <input type="text" name="title" class="form-control" id="module-title"
                ...
                <a href="{{ route('edit-subject', ['subject' => $subject]) }}" class="btn btn-secondary">
                    Annuler
                </a>
            </form>
            <hr>
